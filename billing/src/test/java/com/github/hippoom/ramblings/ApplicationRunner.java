...
public class ApplicationRunner {
	...
	public void run() throws Throwable {
		...
		commandGateway.sendAndWait(new GatherPaymentCommand(trackingId,
				toBeGathered));
	...
	private String makePaymentByCheckWith(final String trackingId,
		...
		return makePaymentWith(trackingId, paidByCheck, By.CHECK, receiptNo);
	}

	private String makePaymentWith(final String trackingId,
			final double paidByCheck, final By by, final String receiptNo) {
	...
	private String makePaymentByCashWith(final String trackingId,
		...
		return makePaymentWith(trackingId, paidByCash, By.CASH, receiptNo);
	}
